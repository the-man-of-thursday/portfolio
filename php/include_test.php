...
table.gsc-search-box td.gsc-input{background:transparent !important}td#gs_tti50{background:transparent !important;border-radius:25px !important}table.gsc-search-box{border-radius:25px !important;background:transparent !important}.gsc-input{border-radius:25px !important}.gsc-input-box{background:var(--main-bg) !important;border:none !important}input:placeholder-shown{color:tomato !important}input#gsc-i-id1{background:var(--main-bg) !important;color:var(--main-text) !important}input#gsc-i-id1:focus{outline:none !important}
}
</style>
<!--normal-->
<style type="text/css">
